...
import com.project.milan.pojos.read_category.Response;
                            ...
                            ivcat.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (layout_cat.getChildCount() > 1) {
                                        ...
                                        Call<Response> call = apiService.read_sub1(Constants.api_key, Utils.GVCOT(txtcat.getText().toString()));
                                        call.enqueue(new Callback<Response>() {
                                            @Override
                                            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                                                            ...
                                                            ivsub1.setOnClickListener(new View.OnClickListener() {
                                                                ...
                                                                public void onClick(View v) {
                                                                    ...
                                                                    if (layout_sub1.getChildCount() > 1) {
                                                                        ...
                                                                        Call<Response> call = apiService.read_sub2(Constants.api_key, Utils.GVCOT(txtcat.getText().toString()), Utils.GVCOT(txtsub1.getText().toString()));
