...
import com.project.milan.adapter.AdapterSearchlist;
...
public class Fragment_Searchlist extends Fragment {
    ...
    private View view;
    private MyGridView grid_searchlist;
    ...
    private void show_searchlist() {
        ...
        if (!Constants.getSearch_word().equals("")) {
           String search_word = "%" + Constants.getSearch_word() + "%";
            ...
            Call<Response> call = apiService.read_item_by_itemname(Constants.api_key, Utils.GVCOT(search_word), from, count);
