...
import com.project.zpace.adapter.AdapterSection;
import com.project.zpace.adapter.AdapterSectionb;
...
import com.project.zpace.pojos.read_item_by_group.DetailsBraItem;
import com.project.zpace.pojos.read_item_by_group.DetailsCatItem;
import com.project.zpace.pojos.read_item_by_group.DetailsColItem;
import com.project.zpace.pojos.read_item_by_group.DetailsItem;
import com.project.zpace.pojos.read_item_by_group.DetailsSizItem;
...
public class Fragment_Section extends Fragment {
    ...
    private View view;
    private List<com.project.zpace.pojos.read_item_by_group.DetailsItem> list = new ArrayList<>();
    private com.project.zpace.custom.MyGridView gridview_section;
    ...
    List<com.project.zpace.pojos.show_dash_gridview.DetailsItem> list_offer = new ArrayList<>();
...
//
    ...
    private void show_offer() {
        ...
        Call<com.project.zpace.pojos.show_dash_gridview.Response> call = apiService.show_dash_offer(Constants.api_key, Parcel4_slno, Parcel4, "4");

        call.enqueue(new Callback<com.project.zpace.pojos.show_dash_gridview.Response>() {
            @Override
            public void onResponse(Call<com.project.zpace.pojos.show_dash_gridview.Response> call, retrofit2.Response<com.project.zpace.pojos.show_dash_gridview.Response> response) {
    ...
    private void show_items() {
        ...
        Call<com.project.zpace.pojos.read_item_by_group.Response> call = apiService.read_item_by_category(Constants.api_key, Utils.GVCOT(Parcel1), from, count, order_by_cash, cat, bra, col, siz);
...
//                            }
    ...
    private void show_group_items() {
        ...
        Call<com.project.zpace.pojos.read_item_by_group.Response> call = apiService.read_item_by_group(Constants.api_key, Parcel2, from, count, order_by_cash, cat, bra, col, siz);
...
//                            }
    ...
    private void show_particular_section() {
        ...
        Call<com.project.zpace.pojos.read_item_by_group.Response> call = apiService.read_item_by_particular_group(Constants.api_key, Parcel3_Category, Parcel3_Sub1, Parcel3_Sub2, from, count, order_by_cash, bra, col, siz);
