...
public class AdapterDashboardGridviewStyle_linear extends BaseAdapter {
    ...
    public AdapterDashboardGridviewStyle_linear(Context context, List<DashEntity> list) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
       ...
       */
            ...
            view = inflater.inflate(R.layout.model_style_linear, null);
          ...
          holder.iv_wave = view.findViewById(R.id.iv_wave);
        ...
        holder.iv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  Toast.makeText(context,""+cpr.getType()+"-lin-"+cpr.getDetails(),Toast.LENGTH_LONG).show();
...
//                            .commit();
      ...
      //  holder.iv_wave.setBackgroundResource(R.drawable.ic_wave_linear22);

        if(position%2==0)
        {
            holder.iv_wave.setRotationY(180);
        }
        else
        {

            holder.iv_wave.setRotationY(360);
        }
