...
public class AdapterFragmentDashboardGridMajor extends BaseAdapter {
    ...
    Context context;
    List<com.project.zpace.pojos.major_category.Detail> list;


    public AdapterFragmentDashboardGridMajor(Context context, List<com.project.zpace.pojos.major_category.Detail> list) {
