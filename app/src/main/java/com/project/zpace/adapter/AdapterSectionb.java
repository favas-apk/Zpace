...
public class AdapterSectionb extends BaseAdapter {


    Context context;
    List<com.project.zpace.pojos.show_dash_gridview.DetailsItem>  list;
    private Appdb db;

    model_offer_calculation offer_class;
    public AdapterSectionb(Context context, List<com.project.zpace.pojos.show_dash_gridview.DetailsItem> list) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
       ...
       */
        ...
        final com.project.zpace.pojos.show_dash_gridview.DetailsItem cpr = list.get(position);
        ...
        String itemcode=   cpr.getDetails();
        ...
        holder.iv_heart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    db.getWishEntityDao().insert_wish_details(new WishEntity(0,itemcode,cpr.getImage(),cpr.getDisplay_name(),cpr.getRate(),cpr.getCompany(),cpr.getColor()));
                    notifyDataSetChanged();
        ...
        holder.ll1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Constants.sceen.equals(Constants.single))
                {
                  ...
                  args.putString("from", "dash_offer");
