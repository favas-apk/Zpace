...
public class AdapterDashboardGridviewStyle3 extends BaseAdapter {
    ...
    public AdapterDashboardGridviewStyle3(Context context, List<DashEntity> list) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
       ...
       */
            ...
            view = inflater.inflate(R.layout.model_style3, null);
        ...
        //        Toast.makeText(context,""+cpr.getType()+"d"+cpr.getDetails(),Toast.LENGTH_LONG).show();
