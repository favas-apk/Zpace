...
import com.project.zpace.pojos.clothes.Detail;
...
public class AdapterFragmentDashboardClothes extends BaseAdapter {
    ...
    Context context;
    List<com.project.zpace.pojos.clothes.Detail> list;


    public AdapterFragmentDashboardClothes(Context context, List<com.project.zpace.pojos.clothes.Detail> list) {
