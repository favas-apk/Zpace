...
import com.project.zpace.pojos.read_category_with_random_images.FnamesItem;
...
public class AdapterCategories extends RecyclerView.Adapter<AdapterCategories.ViewHolderClass>  {
    ...
    Context context;
    List<com.project.zpace.pojos.read_category_with_random_images.DetailsItem> list;
    private List<String> list_banner, list_caption;



    public AdapterCategories(Context context,List<com.project.zpace.pojos.read_category_with_random_images.DetailsItem> list) {
