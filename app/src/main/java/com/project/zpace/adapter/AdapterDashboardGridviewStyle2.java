...
public class AdapterDashboardGridviewStyle2 extends BaseAdapter {
    ...
    public AdapterDashboardGridviewStyle2(Context context, List<DashEntity> list) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
       ...
       */
            ...
            view = inflater.inflate(R.layout.model_style2, null);
