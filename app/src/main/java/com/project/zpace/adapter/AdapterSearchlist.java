...
public class AdapterSearchlist extends BaseAdapter {
    ...
    Context context;
    List<com.project.zpace.pojos.read_item_by_group.DetailsItem> list;
    private Appdb db;
    model_offer_calculation offer_class;

    public AdapterSearchlist(Context context, List<com.project.zpace.pojos.read_item_by_group.DetailsItem> list) {
